        ...
        <div className="container mx-auto flex items-center m-auto max-w-[1215px] h-full w-[90%] justify-between py-2">
          <div
            className={`flex flex-col z-20 relative  ${
              isScrolled
                ? 'w-[10%] phone3:w-[10%] tablet2:w-[10%] desktop1:w-[5%] transition-all duration-700'
                : 'w-[50px] tablet1:w-[90px] desktop1:w-[100px] desktop3:w-[100px] transition-all duration-700'
            }`}
          >
            {' '}
            <img
